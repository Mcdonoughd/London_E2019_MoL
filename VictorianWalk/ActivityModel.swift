 ...
 //this is the activity lookup table
    let ActivityLookUp:[Int:[Activity]] = [
        3:[
            ...
            QuizActivity(name:"Barber Shop",type:"Quiz",question:"What do you think the shaving mugs in the cabinet were for?",answer:"The barber would pour shaving cream in the mug and mix it to build up a lather.",choices: ["","",""],answerIndex:0)
        ],
        ...
        5:[
            ...
            QuizActivity(name:"Tea & Coffee Warehouse",type:"Quiz",question:"How much tea did the average Londoner drink in Victorian times?",answer:"1 pound/year (~150-250 bags/year) In comparison, modern Londoner’s will drink about 550 cups of tea a year",choices:["","",""],answerIndex:0),
        ],
        7:[
        ...
        8:[
            ...
            QuizActivity(name:"Engraver",type:"Quiz",question:"Based on the description, how might the Engraver help the Fancy Stationer nearby?",answer:"The engraver might make templates for business cards and holiday cards and sell the cards to the Stationer to put in their shop.",choices:["","",""],answerIndex:0),
        ],
        12:[
            ...
            QuizActivity(name:"Grocer",type:"Quiz",question:"When do you think the busiest day was for the Grocer?",answer:"Saturdays tended to be the busiest because that was when workers were paid their weekly wages.",choices:["","",""],answerIndex:0)
        ],
        17:[
        ...
        19:[
            ...
            QuizActivity(name:"Bank Manager's Office",type:"Quiz",question:"What fictional character was a money-lender? (Hint: They appear in a Christmas themed book by Charles Dickens)",answer:"Ebenezer Scrooge",choices:["","",""],answerIndex:0)]
        ]
