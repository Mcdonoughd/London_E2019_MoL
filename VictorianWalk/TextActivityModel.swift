...
//    var TextActivity = TextActivity()
    ...
    var ActivityLookUp:[Array<String> : TextActivity] = [
        ...
        ["Tea & Coffee Warehouse","Quiz"]:TextActivity(text:"How much tea did the average Londoner drink in Victorian times?",answer:"1 pound/year (~150-250 bags/year) In comparison, Londoner’s will drink about 550 cups of tea a year"),
