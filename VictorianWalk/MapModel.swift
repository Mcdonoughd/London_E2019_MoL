...
class MapModel{
    ...
    var TitleDesc:[String : Booth] = [
        ...
        "4":Booth(id:4, desc:"Working men would relax in the pub, meet with friends, play darts, or attend political meetings. Children sat outside, awaiting their parents, or were sent in to buy beer for drinking at home.",
            title:"The Pub", hasActivity: false),
        ...
        "15":Booth(id:15,desc:"Tailors catered to \"white-collar\" office workers. Clients first selected a length of material. The tailor measured them, prepared a paper pattern, and cut the cloth. He gave the pieces to an \"outworker\" or assistant to stitch together on a sewing machine.",
            title:"Tailor"),
