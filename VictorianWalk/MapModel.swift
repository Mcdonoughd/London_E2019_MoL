...
class MapModel{
    ...
    var TitleDesc:[String : Booth] = [
        ...
        "10":Booth(id:10, desc:"Introduced for the millions of visitors to the Great Exhibition in 1851, public toilets were available in most towns and railway stations by the 1890s. You had to ‘spend a penny’ to use one. The public lavatories at High Holborn included this urinal, marble panels, and glass cistern.",
            title:"Public Urinal",
            Activities: [.none]),
        ...
        "12":Booth(id:12, desc:"Grocers like Fred Bugg in Bayswater sold the essentials of daily life. Tea, flour, sugar, and rice were drawn from larger containers, then weighed and wrapped for customers. Grocers also sold firewood and paraffin and for the first time, canned and processed foods - condensed milk, tinned fish. They often lived above the shops.",
            title:"Grocer",
            Activities: [.Imagine]),
        ...
        "15":Booth(id:15,desc:"Tailors catered to ‘white-collar’ office workers. Clients first selected a length of material. The tailor measured them, prepared an paper pattern, and cut the cloth. He gave the pieces to an ‘outworker’ or assistant to stitch together on a sewing machine. Poor Londoners had nothing ‘tailor-made,’ but bought used clothes from shops and markets. ",
            title:"Tailor",
            Activities: [.none]),
        "16":Booth(id:16,desc:"Many stationers manufactured popular ‘fancy stationery’ - handmade Christmas and greeting cards, as well as Valentine's cards. Their shops were like newsagents today. They sold newspapers, magazines, cigarettes, and stationery. Daily papers were widely read in London, especially the Daily Telegraph and the Daily Mail.",
